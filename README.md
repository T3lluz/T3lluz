<!--
  ...
  Refreshed automatically by .github/workflows/profile.yml (last run: 2026-09-18 16:29 UTC).
-->
    ...
    <tbody>
      <tr valign="top">
        ...
        <td align="center" width="50%">
          ...
          <br /><sub>PostgreSQL, Supabase, Jetpack Compose, Room / SQLite, Android, Ktor, Node.js, Playwright, React, Vite, Chrome extensions, Tailwind CSS</sub>
        </td>
      </tr>
      <tr>

<!--
  ...
  Refreshed automatically by .github/workflows/profile.yml (last run: 2026-09-24 21:34 UTC).
-->
...
- apps: Room / SQLite, Android, Jetpack Compose, Ktor, KDE Plasma
    ...
    <tbody>
      <tr valign="top">
        ...
        <td align="center" width="50%">
          ...
          <br /><sub>PostgreSQL, Supabase, Room / SQLite, Android, Jetpack Compose, Ktor, Node.js, Playwright, Chrome extensions, Vite, React, KDE Plasma</sub>
        </td>
      </tr>
      <tr>

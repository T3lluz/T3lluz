<!--
  ...
  Refreshed automatically by .github/workflows/profile.yml (last run: 2026-09-18 20:57 UTC).
-->
    ...
    <tbody>
      <tr valign="top">
        ...
        <td align="center" width="50%">
          ...
          <br /><sub>PostgreSQL, Supabase, Room / SQLite, Jetpack Compose, Ktor, Android, Node.js, Playwright, Vite, React, Chrome extensions, React Router</sub>
        </td>
      </tr>
      <tr>

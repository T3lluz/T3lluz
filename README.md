<!--
  ...
  Refreshed automatically by .github/workflows/profile.yml (last run: 2026-09-17 11:48 UTC).
-->
    ...
    <tbody>
      <tr valign="top">
        ...
        <td align="center" width="50%">
          ...
          <br /><sub>PostgreSQL, Supabase, Ktor, Jetpack Compose, Room / SQLite, Android, Node.js, Playwright, Vite, React, Chrome extensions, React Router</sub>
        </td>
      </tr>
      <tr>

<!--
  ...
  Refreshed automatically by .github/workflows/profile.yml (last run: 2026-09-17 21:27 UTC).
-->
    ...
    <tbody>
      <tr valign="top">
        ...
        <td align="center" width="50%">
          ...
          <br /><sub>PostgreSQL, Supabase, Jetpack Compose, Ktor, Android, Room / SQLite, Node.js, Playwright, Vite, React, Chrome extensions, Tailwind CSS</sub>
        </td>
      </tr>
      <tr>

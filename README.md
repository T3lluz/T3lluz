<!--
  ...
  Refreshed automatically by .github/workflows/profile.yml (last run: 2026-09-18 11:23 UTC).
-->
...
- apps: Jetpack Compose, Ktor, Room / SQLite, Android, Qt / QML
    ...
    <tbody>
      <tr valign="top">
        ...
        <td align="center" width="50%">
          ...
          <br /><sub>Supabase, PostgreSQL, Jetpack Compose, Ktor, Room / SQLite, Android, Node.js, Playwright, React, Vite, Chrome extensions, React Router</sub>
        </td>
      </tr>
      <tr>

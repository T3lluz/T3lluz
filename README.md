<!--
  ...
  Refreshed automatically by .github/workflows/profile.yml (last run: 2026-09-18 04:50 UTC).
-->
    ...
    <tbody>
      <tr valign="top">
        ...
        <td align="center" width="50%">
          ...
          <br /><sub>Supabase, PostgreSQL, Android, Ktor, Room / SQLite, Jetpack Compose, Node.js, Playwright, React, Vite, Chrome extensions, Tailwind CSS</sub>
        </td>
      </tr>
      <tr>

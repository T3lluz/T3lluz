<!--
  ...
  Refreshed automatically by .github/workflows/profile.yml (last run: 2026-09-16 23:40 UTC).
-->
...
- apps: Jetpack Compose, Android, Ktor, Room / SQLite, Qt / QML
    ...
    <tbody>
      <tr valign="top">
        ...
        <td align="center" width="50%">
          ...
          <br /><sub>Supabase, PostgreSQL, Jetpack Compose, Android, Ktor, Room / SQLite, Node.js, Playwright, React, Vite, Chrome extensions, Tailwind CSS</sub>
        </td>
      </tr>
      <tr>

<!--
  ...
  Refreshed automatically by .github/workflows/profile.yml (last run: 2026-09-17 04:57 UTC).
-->
    ...
    <tbody>
      <tr valign="top">
        ...
        <td align="center" width="50%">
          ...
          <br /><sub>PostgreSQL, Supabase, Android, Room / SQLite, Jetpack Compose, Ktor, Node.js, Playwright, React, Vite, Chrome extensions, React Router</sub>
        </td>
      </tr>
      <tr>
